 ...
 * Version: 1.0
 * Author: Shawn Kemp
 * Author URI: https://github.com/Skemp45
 * License: GPL2
 */
...
{
    // JS
    wp_register_script('CCC_bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js');
    wp_enqueue_script('CCC_bootstrap');
    wp_register_script('CCC_jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js');
    wp_enqueue_script('CCC_jquery');
    // CSS
    wp_register_style('CCC_bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
